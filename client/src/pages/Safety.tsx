    ...
    <div className="min-h-[100dvh] bg-[#F8FAFC] font-sans selection:bg-emerald-500/30 overflow-hidden relative flex flex-col">
      ...
      <div className="sticky top-0 z-40 px-4 pt-4 pb-2">
        <motion.div 
          ...
          className="flex items-center justify-between bg-white/70 backdrop-blur-3xl border border-white/50 shadow-[0_8px_30px_rgba(0,0,0,0.04)] rounded-[24px] px-4 py-3 max-w-[800px] mx-auto w-full mb-4"
        >
          ...
          <div className="flex flex-col items-center justify-center absolute left-1/2 -translate-x-1/2">
            ...
            <p className="text-[10px] text-slate-500 font-bold tracking-widest uppercase">Guidelines</p>
          </div>
